...
class HunYuanVLProcessor(ProcessorMixin):
    ...
    def from_pretrained(cls, *args, **kwargs):
        # vLLM main passes the native processor's image backend API. Keep the
        # vendored 0706 processor path equivalent to the pre-upgrade behavior.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # vLLM main wraps image placeholders for the native 5.13 processor.
        # Empty compatibility wrappers preserve the 0706 prompt format.
